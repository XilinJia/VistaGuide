...
class BandcampSearchStreamInfoItemExtractor(private val searchResult: Element, uploaderUrl: String) : BandcampStreamInfoItemExtractor(uploaderUrl) {
    ...
    override fun getUploaderName(): String? {
        ...
        return if (splitBy.size > 1) splitBy[1] else { splitBy[0] }
    }
