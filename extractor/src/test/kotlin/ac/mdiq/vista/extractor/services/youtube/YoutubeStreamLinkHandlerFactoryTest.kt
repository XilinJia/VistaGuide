...
class YoutubeStreamLinkHandlerFactoryTest {
    ...
    @ParameterizedTest
    @CsvSource("W-fFHeTX70Q,https://www.youtube.com/watch?v=W-fFHeTX70Q",
    ...
    @ParameterizedTest
    @CsvSource("TglNG-yjabU,https://hooktube.com/watch?v=TglNG-yjabU",
    ...
    @ParameterizedTest
    @CsvSource("TglNG-yjabU,https://invidious.fdn.fr/watch?v=TglNG-yjabU",
    ...
    companion object {
        ...
        @BeforeAll
        fun setUp() {
            linkHandler = YoutubeStreamLinkHandlerFactory.instance
            init(getInstance())
        }
    }
}
